...
const lessImports = require(`./${baseName}.json`).lessImports;
...
module.exports = {
  ...
  enableTheme(theme, isPreview) {
    console.log(isPreview ? 'preview' : 'not preview');
    try {
